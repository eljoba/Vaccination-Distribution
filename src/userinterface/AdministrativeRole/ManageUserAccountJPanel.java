...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        error = enterprise.getUserAccountDirectory().checkIfUsernameExists(userName);
        if (error) {
            error = true;
        ...
        if (!error) {
            if (userName.trim().equals("")) {
                error = true;
                errorMessage += "Username field cannot be blank\n";
            ...
            if (!error) {
                ...
                if (ua == null) {
                    JOptionPane.showMessageDialog(null, "User account already exists for the person");
                } else {
